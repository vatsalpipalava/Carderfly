...
export const LampContainer = ({
  ...
  return (
    (<div
      className={cn(
        "relative flex min-h-screen flex-col items-center justify-center overflow-hidden bg-muted w-full rounded-md z-0",
        className
      )}>
      <div
        ...
        <motion.div
          ...
          <div
            className="absolute  w-[100%] left-0 bg-muted h-40 bottom-0 z-20 [mask-image:linear-gradient(to_top,white,transparent)]" />
          <div
            className="absolute  w-40 h-[100%] left-0 bg-muted  bottom-0 z-20 [mask-image:linear-gradient(to_right,white,transparent)]" />
        </motion.div>
        <motion.div
          initial={{ opacity: 0.5, width: "15rem" }}
          whileInView={{ opacity: 1, width: "30rem" }}
          ...
          <div
            className="absolute  w-40 h-[100%] right-0 bg-muted  bottom-0 z-20 [mask-image:linear-gradient(to_left,white,transparent)]" />
          <div
            className="absolute  w-[100%] right-0 bg-muted h-40 bottom-0 z-20 [mask-image:linear-gradient(to_top,white,transparent)]" />
        </motion.div>
        <div
          className="absolute top-1/2 h-48 w-full translate-y-12 scale-x-150 bg-muted blur-2xl"></div>
        <div
        ...
        <div
          className="absolute inset-auto z-40 h-44 w-full -translate-y-[12.5rem] bg-muted "></div>
      </div>
