...
const SocialShareHome = () => {
  ...
  return (
    <ShineBorder
      className="relative flex h-full w-full flex-col items-center justify-center overflow-hidden rounded-lg border bg-background p-1 md:shadow-xl"
      color={["#DC2626", "#FE8FB5", "#FFBE7B"]}
    >
      <div
        className="relative flex h-full w-full items-center justify-center overflow-hidden rounded-xl border-none bg-transparent p-10"
        ref={containerRef}
      >
        <div className="flex size-full max-h-[200px] max-w-lg flex-col items-stretch justify-between gap-10">
          <div className="flex flex-row items-center justify-between">
            <Circle ref={div1Ref}>
              {/* <Icons.googleDrive /> */}
              <FaFacebookSquare className="h-6 w-6 text-[#0866FF]" />
            </Circle>
            <Circle ref={div5Ref}>
              <FaInstagram className="h-6 w-6 text-[#DD2A7B]" />
            </Circle>
          </div>
          <div className="flex flex-row items-center justify-between">
            <Circle ref={div2Ref}>
              <RxLinkedinLogo className="h-6 w-6 text-[#0A66C2]" />
            </Circle>
            <Circle ref={div4Ref} className="size-16">
              <RiLink className="h-8 w-8 text-[#000000]" />
            </Circle>
            <Circle ref={div6Ref}>
              <FaYoutube className="h-6 w-6 text-[#FF0000]" />
            </Circle>
          </div>
          <div className="flex flex-row items-center justify-between">
            <Circle ref={div3Ref}>
...
export default SocialShareHome;
